...
def load_model(
    ...
    *,
    ...
    if model_ckpt_path.is_dir():
        if ema:
            state = {"ema": {"model": model.state_dict()}}
...
def render_mesh_preview(
    ...
    *,
    ...
    if joints is not None and joint_parents is not None:
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Validate humanoid joint-octree stage 1 and NEXUS stage 2.")
    parser.add_argument("--stage1-output-root", default="./outputs/humanoid_joint_octree_front_overfit_small12")
    parser.add_argument("--stage1-ckpt", default="")
    parser.add_argument("--stage1-config", default="torchtitan/experiments/humanoid/configs/front_overfit_small12.toml")
    ...
    parser.add_argument("--output-dir", default="./outputs/humanoid_joint_octree_front_overfit_small12/validation_i2v_v2f")
...
def main() -> int:
    ...
    stage1_pipe = ImageToJointOctreePipeline(
