#!/usr/bin/env python3
"""Validate single-stream semantic joints with clean GT mesh tokens."""
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Predict joints in one stream with clean GT mesh octree layers."
    )
    parser.add_argument(
        "--stage1-output-root",
        default="./outputs/humanoid_single_stream_front_qem20k_smoke100",
    )
    ...
    parser.add_argument(
        "--output-dir",
        default=(
            "./outputs/humanoid_single_stream_front_qem20k_smoke100/"
