...
CONFIG_FILE=${CONFIG_FILE:-"exp/full/structure_tripo3_r128_7B_siglip_cc_dino.toml"}
# resume the newest checkpoint if exists
PRETRAIN_PATH=${PRETRAIN_PATH:-""}
# experiment name
NAME=${NAME:-"structure-7B-tripo3_485w-c32d8r128v0625-patch1-shift2-rope4d-siglip2n20_cc_dinov2l-bs16x30"}
# log path
...
-m torchtitan.experiments.trellis.train_structure --job.config_file ./torchtitan/experiments/trellis/configs/${CONFIG_FILE} \
