...
@_torch_custom_op_wrapper("flash_attn3::_flash_attn_forward", mutates_args=(), device_types="cuda")
def _flash_attn_forward(
        ...
        kv_batch_idx: torch.Tensor,
        leftpad_k: torch.Tensor,
        rotary_cos: torch.Tensor,
        rotary_sin: torch.Tensor,
        seqlens_rotary: torch.Tensor,
...
@_torch_register_fake_wrapper("flash_attn3::_flash_attn_forward")
...
@_torch_custom_op_wrapper("flash_attn3::_flash_attn_backward", mutates_args=("dq", "dk", "dv"), device_types="cuda")
def _flash_attn_backward(
        ...
        cu_seqlens_q: Optional[torch.Tensor],
        cu_seqlens_k: Optional[torch.Tensor],
        sequed_q: torch.Tensor,
        sequed_k: torch.Tensor,
        max_seqlen_q: Optional[int],
        max_seqlen_k: Optional[int],
        dq: torch.Tensor,
        dk: torch.Tensor,
...
@_torch_register_fake_wrapper("flash_attn3::_flash_attn_backward")
...
if torch.__version__ >= "2.4.0":
    _wrapped_flash_attn_forward = torch.ops.flash_attn3._flash_attn_forward
    _wrapped_flash_attn_backward = torch.ops.flash_attn3._flash_attn_backward
else:
