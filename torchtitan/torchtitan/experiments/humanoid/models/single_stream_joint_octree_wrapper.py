"""TorchTitan wrapper for the single-stream mesh-conditioned joint model."""
...
from torchtitan.experiments.humanoid.models.single_stream_joint_octree import (
    SingleStreamJointOctreeDiffusionModel,
)
from torchtitan.tools.logging import logger

@dataclass
class SingleStreamJointOctreeDiffusionArgs(BaseModelArgs):
...
class SingleStreamJointOctreeDiffusionWrapper(
    SingleStreamJointOctreeDiffusionModel, ModelProtocol
):
    def __init__(self, model_args: SingleStreamJointOctreeDiffusionArgs):
        super().__init__(**asdict(model_args))

    @classmethod
    def from_model_args(
        cls, model_args: SingleStreamJointOctreeDiffusionArgs
