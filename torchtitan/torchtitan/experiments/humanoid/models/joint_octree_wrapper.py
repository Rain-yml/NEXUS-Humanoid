# Owned copy of experiments/vem/models/octree_wrapper.py.
...
from torchtitan.experiments.humanoid.models.joint_octree import JointOctreeDiffusionModel
from torchtitan.tools.logging import logger

@dataclass
class JointOctreeDiffusionArgs(BaseModelArgs):
...
class JointOctreeDiffusionWrapper(JointOctreeDiffusionModel, ModelProtocol):
    def __init__(self, model_args: JointOctreeDiffusionArgs):
        super().__init__(**asdict(model_args))

    @classmethod
    def from_model_args(cls, model_args: JointOctreeDiffusionArgs) -> "JointOctreeDiffusionWrapper":
