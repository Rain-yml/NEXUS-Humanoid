"""TorchTitan wrapper for reference-conditioned arbitrary skeleton training."""
...
from torchtitan.experiments.humanoid.models.reference_skeleton_single_stream import (
    ReferenceSkeletonSingleStreamDiffusionModel,
)
from torchtitan.tools.logging import logger

@dataclass
class ReferenceSkeletonSingleStreamDiffusionArgs(BaseModelArgs):
...
class ReferenceSkeletonSingleStreamDiffusionWrapper(
    ReferenceSkeletonSingleStreamDiffusionModel, ModelProtocol
):
    def __init__(self, model_args: ReferenceSkeletonSingleStreamDiffusionArgs):
        super().__init__(**asdict(model_args))

    @classmethod
    def from_model_args(
        cls, model_args: ReferenceSkeletonSingleStreamDiffusionArgs
