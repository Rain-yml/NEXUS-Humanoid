# Should be synced with https://github.com/pytorch/pytorch/blob/main/torch/distributed/tensor/experimental/_attention.py
# but there're some compatibility issues.
...
def set_enable_load_balance(enable_load_balance: bool) -> None:
    """
    Only causal attention supports load balance.

    Args:
        enable_load_balance (bool): whether to enable load balance.
