...
@dataclass
class OctreeDiffusionArgs(BaseModelArgs):
...
class OctreeDiffusionWrapper(OctreeDiffusionModel, ModelProtocol):
    def __init__(self, model_args: OctreeDiffusionArgs):
        super().__init__(**asdict(model_args))

    @classmethod
    def from_model_args(cls, model_args: OctreeDiffusionArgs) -> "OctreeDiffusionWrapper":
