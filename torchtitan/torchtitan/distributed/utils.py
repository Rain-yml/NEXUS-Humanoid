...
def create_context_parallel_ctx(
    ...
    cp_enable_load_balance: bool = True,
):
    try:
        # from torch.distributed.tensor.experimental import context_parallel
        # from torch.distributed.tensor.experimental._attention import set_rotate_method
        from torchtitan.experiments.trellis.context_parallel import context_parallel, set_rotate_method, set_enable_load_balance
    except ImportError:
        print(
    ...
    set_enable_load_balance(cp_enable_load_balance)
